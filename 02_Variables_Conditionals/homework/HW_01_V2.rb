...
def validate_guess(user_guess, num_range_low, num_range_high)
...
def check_answer (guess, secret_number, name)
...
while rounds_to_play > 0 do
	...
	if validate_guess(user_guess, num_range_low, num_range_high)
		check_answer(user_guess, secret_number, name)
   		rounds_to_play -= 1
	end
end
